<template>
  <BaseCard class="q-pa-lg">
    ...
    <div>
      ...
      mollitia vero laboriosam atque sed fugit blanditiis deserunt, porro ullam
      ex quaerat nesciunt perferendis, doloremque impedit sit repudiandae
      similique veniam obcaecati.<br />
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit,
      mollitia vero laboriosam atque sed fugit blanditiis deserunt, porro ullam
      ex quaerat nesciunt perferendis, doloremque impedit sit repudiandae
      similique veniam obcaecati.<br />
